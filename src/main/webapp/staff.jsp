	...
	<div class="col-5 col-md-11 mr-5 ml-5">
	    ...
	    <nav>
	        <div class="nav nav-tabs tabnav" id="nav-tab" role="tablist">
	            ...
	            <a class="nav-item nav-link tabnav" data-toggle="tab" href="#add-staff" role="tab" aria-controls="add-staff" aria-selected="false">Add New Employees</a>
	            <a class="nav-item nav-link tabnav" data-toggle="tab" href="#update-staff" role="tab" aria-controls="update-staff" aria-selected="false">Update Employee Information</a>
	            <a class="nav-item nav-link tabnav" data-toggle="tab" href="#delete-staff" role="tab" aria-controls="delete-staff" aria-selected="false">Delete Employees</a>
	        </div>
	    </nav>
